...
const DespesaParcelaTableListToView = ({ id }: Props) => {
  // ** Hooks
...
DespesaParcelaTableListToView.acl = {
  action: 'list',
  subject: 'ac-despesaParcela-page'
}

export default DespesaParcelaTableListToView